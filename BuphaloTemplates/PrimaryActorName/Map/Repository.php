...
/** @neighborhoods-buphalo:annotation-processor Neighborhoods\GeolocationComponent\AnnotationProcessor\Actor\Repository-JsonColumns
 */
    ];
...
/** @neighborhoods-buphalo:annotation-processor Neighborhoods\GeolocationComponent\AnnotationProcessor\Actor\Repository-insertElement
 */
    ...
    protected function updateElement(QueryBuilder $queryBuilder,
                                     PrimaryActorNameInterface $PrimaryActorName) : PrimaryActorNameInterface
    {
/** @neighborhoods-buphalo:annotation-processor Neighborhoods\GeolocationComponent\AnnotationProcessor\Actor\Repository-updateElement
 */
        $queryBuilder
            ->update(PrimaryActorNameInterface::TABLE_NAME)
            ->where($queryBuilder->expr()->eq(
        /** @neighborhoods-buphalo:annotation-processor Neighborhoods\GeolocationComponent\AnnotationProcessor\Actor\Repository-updateElementIdentityField
